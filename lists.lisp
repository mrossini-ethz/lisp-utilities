...
(defun l=3 (list)
  (check-type list list)
  (and (consp list) (consp (cdr list)) (consp (cddr list)) (null (cdddr list))))
(export 'l=3)

(declaim (inline l=4))
(defun l=4 (list)
  (check-type list list)
  (and (consp list) (consp (cdr list)) (consp (cddr list)) (consp (cdddr list)) (null (cddddr list))))
(export 'l=4)
...
(defun l>1 (list)
  (check-type list list)
  (and (consp list) (consp (cdr list)) (listp (cddr list))))
(export 'l>1)

(declaim (inline l>2))
(defun l>2 (list)
  (check-type list list)
  (and (consp list) (consp (cdr list)) (consp (cddr list)) (listp (cdddr list))))
(export 'l>2)

(declaim (inline l>3))
(defun l>3 (list)
  (check-type list list)
  (and (consp list) (consp (cdr list)) (consp (cddr list)) (consp (cdddr list)) (listp (cddddr list))))
(export 'l>3)

(declaim (inline l>4))
(defun l>4 (list)
  (check-type list list)
  (and (consp list) (consp (cdr list)) (consp (cddr list)) (consp (cdddr list)) (consp (cddddr list)) (listp (cdr (cddddr list)))))
(export 'l>4)
